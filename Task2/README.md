...
- Обращаем внимание на количество реплик. Оно увеличивается по мере роста нагрузки, генерируемой Locust, и постепенно достигает целевого значения (максимум 10).  
...
- Команды, выполняемые в консоли.  

![Консоль](deployments-scaletestapp-console.png)
