...
- **Необходимость хранилища данных**: 
  - Да, требуется. `osago-aggregator` необходимо хранить информацию о статусе заявок, идентификаторах заявок в страховых компаниях, а также полученные предложения. Это позволит:
...
### Интеграция между веб-приложением и core-app:
